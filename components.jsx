    ...
    <header className="nav">
      <div className="container-wide nav-inner">
        ...
        <div className="nav-actions">
          ...
          <button className="btn btn-primary" onClick={() => setPage("submit")}>Submit a Video</button>
        </div>
      </div>
    </header>
  );
      ...
      <div className="container-wide">
        <div className="footer-grid">
          ...
          <div>
            <h5>Platform</h5>
            <ul>
              <li><a onClick={() => setPage("library")}>Video Library</a></li>
              <li><a onClick={() => setPage("submit")}>Submit a Video</a></li>
              <li><a>Events</a></li>
              <li><a>Education</a></li>
          ...
          <div>
            <h5>About</h5>
            <ul>
              <li><a onClick={() => setPage("about")}>Who we are</a></li>
              <li><a>Editorial Board</a></li>
              <li><a>Peer Review Process</a></li>
              <li><a>Contact</a></li>
            </ul>
          </div>
          <div>
            <h5>Legal</h5>
            <ul>
              <li><a>Educational use policy</a></li>
              <li><a>De-identification standard</a></li>
              <li><a>Terms</a></li>
              <li><a>Privacy</a></li>
            </ul>
          </div>
...
function VideoCard({ v, onOpen }) {
  return (
    <div className="vcard" onClick={() => onOpen(v)} data-comment-anchor={`vcard-${v.id}`}>
...
Object.assign(window, { Icon, Logo, Nav, Footer, VideoCard, ThumbDecor });
