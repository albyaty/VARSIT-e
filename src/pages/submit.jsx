    ...
    return (
      <main style={{ paddingTop: 80, paddingBottom: 120 }}>
        <div className="container" style={{ maxWidth: 720, textAlign: "center" }}>
          ...
          <h1 style={{ fontSize: "clamp(32px, 6vw, 48px)", marginTop: 16 }}>Thank you, {form.name || "Doctor"}.</h1>
          ...
          <div className="flex gap-12" style={{ justifyContent: "center", marginTop: 40, flexWrap: "wrap" }}>
    ...
    <main>
      <section style={{ paddingTop: 64, paddingBottom: 24, borderBottom: "1px solid var(--border-soft)" }}>
        <div className="container" style={{ maxWidth: 1080 }}>
          ...
          <h1 style={{ fontSize: "clamp(32px, 6vw, 48px)", marginTop: 16 }}>Publish your teaching case.</h1>
      ...
      <section style={{ paddingTop: 32, paddingBottom: 96 }}>
        <div className="container submit-grid" style={{ maxWidth: 1080 }}>
          {/* Stepper */}
          <aside className="sticky-side">
            ...
            <div style={{ marginTop: 24, padding: 16, background: "var(--surface-2)", border: "1px solid var(--border-soft)", borderRadius: 10, fontSize: 12, color: "var(--text-3)", lineHeight: 1.5 }}>
              ...
              Read the editorial standards or contact <a href="mailto:editors@varsit-e.org" style={{ color: "var(--accent)" }}>editors@varsit-e.org</a>.
            </div>
          </aside>
          ...
          <div className="card" style={{ padding: "clamp(24px, 4vw, 40px)" }}>
            ...
            <div style={{ marginTop: 40, paddingTop: 24, borderTop: "1px solid var(--border-soft)", display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
              ...
              {step < steps.length - 1 ? (
                ...
                <button className="btn btn-primary"
                  ...
                  onClick={() => { if (form.consentDeident && form.consentEdu) { setSubmitted(true); window.scrollTo(0, 0); } }}>
    ...
    <>
      ...
      <FormSection title="Video source" sub="We recommend hosting on Vimeo (unlisted, password-protected) or YouTube (unlisted) — VARSIT-E embeds your hosted player so quality, captions and analytics stay with you. Direct uploads are also accepted for archival.">
        ...
        {form.uploadKind === "link" ? (
          ...
          <div className="hostopts" style={{ gap: 12, marginTop: 8 }}>
            {[
...
function Summary({ l, v }) {
  return (
    <div style={{ display: "flex", justifyContent: "space-between", padding: "8px 0", fontSize: 14, borderBottom: "1px solid var(--border-soft)", gap: 16 }}>
